...
<form class="card" action="src/actions/register.php" method="post" enctype="multipart/form-data">
    <h2>Зарегистрируйтесь, как новый пользователь</h2>
    ...
    <label for="avatar">Загрузите фотографию
        <input
            type="file"
            id="avatar"
            name="avatar"
...
<p>Если у вас есть аккаунт, то перейдите на свой <a href="/">аккаунт</a></p>
